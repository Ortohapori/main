...
const Vegetable = () => {
  const { id } = useParams();
  const vegetable = vegetables.find((v) => v.id === parseInt(id!, 10));

  if (!vegetable) {
    return <div>Hortaliça não encontrada</div>;
  }
  ...
  return (
    <Card
      cover={
        <img
          src={vegetable.image}
          alt={vegetable.nome_popular}
          style={{ width: "100%", height: 300, objectFit: "cover" }}
        />
      }
      title={vegetable.nome_popular}
    >
      <Row
        gutter={[16, 16]}
        title={vegetable.nome_popular}
      ...
      >
        <Col>
          <Descriptions
            ...
            layout="vertical"
          >
            <Descriptions.Item label="Nome Científico">
              {vegetable.nome_cientifico}
            </Descriptions.Item>
            <Descriptions.Item label="Descrição">
              {vegetable.descricao}
            </Descriptions.Item>
            <Descriptions.Item label="Tipo de Colheita">
              {vegetable.tipo_de_colheita}
            </Descriptions.Item>
            <Descriptions.Item label="Melhor Estação para Cultivo">
              {vegetable.melhor_estacao_para_cultivo}
            </Descriptions.Item>
            <Descriptions.Item label="Resistência a Pragas">
              {vegetable.resistencia_a_pragas}
            </Descriptions.Item>
            <Descriptions.Item label="Época e Regiões para Plantio">
              {vegetable.epoca_e_regioes_para_plantio}
            </Descriptions.Item>
            <Descriptions.Item label="Solo">{vegetable.solo}</Descriptions.Item>
            <Descriptions.Item label="Temperatura">
              {vegetable.temperatura}
            </Descriptions.Item>
            <Descriptions.Item label="Semeadura">
              {vegetable.semeadura}
            </Descriptions.Item>
            <Descriptions.Item label="Espaçamento">
              {vegetable.espacamento}
            </Descriptions.Item>
            <Descriptions.Item label="Transplantio">
              {vegetable.transplantio}
            </Descriptions.Item>
            <Descriptions.Item label="Irrigação">
              {vegetable.irrigacao}
            </Descriptions.Item>
            <Descriptions.Item label="Adubação">
              {vegetable.adubacao}
            </Descriptions.Item>
            <Descriptions.Item label="Colheita">
              {vegetable.colheita}
            </Descriptions.Item>
            <Descriptions.Item label="Recomendações de Aproveitamento">
              {vegetable.recomendacoes_de_aproveitamento}
            </Descriptions.Item>
          </Descriptions>
        </Col>
      </Row>
